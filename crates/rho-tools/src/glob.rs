...
use crate::{cancel::CancelToken, error::Result, fs_cache, glob_util};
...
///
/// If `sort_by_mtime` is enabled, all matching entries are collected, sorted by
/// descending mtime, then truncated to `max_results`.
///
/// # Errors
