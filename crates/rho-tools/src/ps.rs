...
mod platform {
	...
	#[repr(C)]
	#[allow(non_snake_case, reason = "Win32 API naming convention")]
	...
	fn build_process_tree() -> HashMap<u32, SmallVec<[u32; 4]>> {
		...
		// SAFETY: Win32 API calls are safe with valid parameters.
		unsafe {
	...
	pub fn kill_pid(pid: i32, _signal: i32) -> bool {
		// SAFETY: Win32 API calls are safe with valid handle management.
		unsafe {
